      ...
      case 'modelQube':
        return (
          <div className="space-y-1">
            ...
            <div className="text-xs">
              Contains AI models that provide language processing, reasoning, or specialized AI capabilities. Examples include privacy-preserving models and specialized language models.
            </div>
          </div>
        );
      case 'voice':
