...
const MetaAvatarTab: React.FC = () => {
  ...
  useEffect(() => {
    ...
    console.log('[MetaAvatarTab] Initializing with containerId:', containerId);
    ...
    // Set the unique id directly on the container
    ...
    console.log('[MetaAvatarTab] Initialization complete');

    // Cleanup on unmount
    return () => {
      console.log('[MetaAvatarTab] Unmounting, cleaning up');
